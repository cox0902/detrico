...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, tgt, tgt_mask, query_embed, pos_embed):
        ...
        hs = self.decoder(tgt, memory, tgt_key_padding_mask=tgt_mask, memory_key_padding_mask=mask,
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward_post(self, tgt, memory,
        ...
        v = tgt if not self.tgt_value_with_pos else self.with_pos_embed(tgt, query_pos)
